...
//        console.log(wells.getAttribute('data-key'));
//        if(wells.length > 0){
//            var root = wells[0];
//            root.style.display = '';
//        }
...
//        this.container.appendChild(this.description);
      ...
      this.editor_holder = this.theme.getIndentedPanel(this.key, function(){
        if(self.parent){
        }
      });
  ...
  build: function() {
    ...
    if(!this.options.compact) {
      ...
      if(this.schema.format === 'tabs') {
        ...
        this.panel = this.theme.getIndentedPanel(this.key);
